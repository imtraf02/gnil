...
GNIL is made possible by the work of many open-source projects and contributors.

## Design & Branding

- **[Caelestia](https://github.com/caelestia-dots/shell)** — Visual and interaction inspiration
- **[Noctalia](https://github.com/noctalia-dev/noctalia)** — Original MIT-licensed renderer and service foundation
...
- **[Google Material Symbols](https://fonts.google.com/icons)** — Rounded variable icon font used throughout the shell
...
External tools GNIL integrates with at runtime when present:
...
- All Noctalia contributors whose MIT-licensed work forms part of GNIL's foundation
- All GNIL contributors and early Version 0 Beta users

## License

GNIL is licensed under the MIT License. See [LICENSE](LICENSE) for details.
