...
public:
  ...
  /// Use one SurfaceVariant fill with no focus/hover outline, as required by
  /// pill-shaped search fields that already live inside a focused panel.
  void setFlatSurfaceFrame(bool enabled);
