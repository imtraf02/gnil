...
namespace Style {
  ...
  // General chrome timing. Bar popouts use dedicated Caelestia-derived
  // spatial/effects tokens below so unrelated shell animations stay intact.
  inline constexpr int animChromeSpatial = 400;
  inline constexpr int animChromeExit = 200;
  inline constexpr int animBarPopoutSpatial = 500;
  inline constexpr int animBarPopoutContentIn = 300;
  inline constexpr int animBarPopoutContentOut = 200;
  ...
  inline constexpr float sliderInsideCornerRadius = 2.0f;
  inline constexpr float sliderStopIndicatorSize = 4.0f;
  inline constexpr float sliderHorizontalPadding = sliderHandleWidth * 0.5f;
