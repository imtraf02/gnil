...
void GlesRenderBackend::drawChromeBlob(
  ...
  m_chromeBlobProgram.ensureInitialized();
  m_chromeBlobProgram.draw(
      surfaceWidth, surfaceHeight, pixelScaleX, pixelScaleY, width, height, style, transform
  );
}
