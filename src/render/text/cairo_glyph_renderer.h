...
// Direct FreeType + Cairo renderer for single codepoints in the vendored
// Material Symbols Rounded variable font. No Pango, shaping or fallback.
...
private:
  ...
  CacheEntry* lookupOrRasterize(char32_t codepoint, float fontSize, float fill);
