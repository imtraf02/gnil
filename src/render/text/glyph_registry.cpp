...
namespace {
  ...
  const std::unordered_map<std::string, std::string_view> kAliases = {
      ...
      {"grid-dots", "apps"}, {"layout-grid", "grid_view"}, {"calculator", "calculate"},
      {"adjustments-horizontal", "tune"}, {"file-text", "description"},
      {"layout-bottombar", "dock_to_bottom"}, {"layout-bottombar-inactive", "dock_to_bottom"},
      {"map-pin-off", "location_off"},
      {"menu-2", "menu"}, {"gnil", "auto_awesome"}, {"photo-off", "hide_image"},
