...
namespace noctalia::theme {
  ...
  public:
    ...
    void setLiveWallpaperPaletteProvider(LiveWallpaperPaletteProvider provider);
  ...
  private:
    ...
    resolveLiveWallpaperGenerated(const ThemeConfig& cfg, const LiveWallpaperPaletteSource& source);
    ...
    std::optional<GeneratedPalette> m_liveWallpaperCacheGenerated;
    std::string m_liveWallpaperCacheIdentity;
    std::string m_liveWallpaperCacheScheme;
    LiveWallpaperPaletteProvider m_liveWallpaperPaletteProvider;

    ChangeCallback m_changeCallback;
    ResolvedCallback m_resolvedCallback;
    // External palette callbacks are delayed until the shell palette is
