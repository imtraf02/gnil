...
namespace gnil::theme {
  ...
  namespace {
    ...
    std::unique_ptr<mcu::DynamicScheme> makeScheme(const mcu::Hct& source, Scheme scheme, bool isDark) {
      ...
      case Scheme::Vibrant:
        return std::make_unique<mcu::SchemeVibrant>(source, isDark, 0.0);
      case Scheme::Expressive:
        return std::make_unique<mcu::SchemeExpressive>(source, isDark, 0.0);
      case Scheme::Fidelity:
        return std::make_unique<mcu::SchemeFidelity>(source, isDark, 0.0);
      case Scheme::Content:
      ...
      case Scheme::Neutral:
        return std::make_unique<mcu::SchemeNeutral>(source, isDark, 0.0);
