...
void WaylandSeat::setShellKeyboardFocusCallback(KeyboardFocusCallback callback) {
  m_shellKeyboardFocusCallback = std::move(callback);
}
...
void WaylandSeat::handleKeyboardEnter(
  ...
  if (self->m_shellKeyboardFocusCallback) {
    self->m_shellKeyboardFocusCallback(surface, true);
  }
}
...
void WaylandSeat::handleKeyboardLeave(
  ...
  if (self->m_shellKeyboardFocusCallback) {
    self->m_shellKeyboardFocusCallback(surface, false);
  }
}
