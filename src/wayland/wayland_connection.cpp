...
void WaylandConnection::setShellKeyboardFocusCallback(WaylandSeat::KeyboardFocusCallback callback) {
  m_seatHandler.setShellKeyboardFocusCallback(std::move(callback));
}
