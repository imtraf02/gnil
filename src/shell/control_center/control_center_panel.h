...
public:
  ...
  [[nodiscard]] float initialVisualWidth() const override { return scaled(854.0f); }
...
private:
  ...
  void layoutDashboardTabIndicator();
  void syncDashboardVisualSize(bool animate);
  ...
  Segmented* m_dashboardTabStrip = nullptr;
  Box* m_dashboardTabIndicator = nullptr;
  ...
  std::vector<TabId> m_dashboardTabSlots;
