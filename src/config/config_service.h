...
private:
  ...
  // The only public configuration directory.  settings.toml is the sole
  // configuration source; state.toml remains app-owned runtime state.
  std::string m_configDir;

  // User-editable Settings/Style document in the config directory.
