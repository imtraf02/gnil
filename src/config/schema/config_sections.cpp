  ...
  namespace {
    ...
    const std::vector<SectionSpec>& sectionTable() {
      static const std::vector<SectionSpec> table = [] {
        ...
        t.push_back(makeSection("nexus", &Config::nexus, nexusSchema()));
        t.push_back(makeSection("default_apps", &Config::defaultApps, defaultAppsSchema()));
        ...
        t.push_back(makeSection("sidebar", &Config::sidebar, sidebarSchema()));
        t.push_back(makeSection("dashboard", &Config::dashboard, dashboardSchema()));
