...
namespace gnil::config::schema {
  ...
  inline constexpr Range<float> kChromeFrameThicknessRange{1.0f, 100.0f, 1.0f};
  inline constexpr Range<float> kChromeRoundingRange{1.0f, 200.0f, 1.0f};
  ...
  inline constexpr Range<std::int64_t> kClipboardHistoryMaxEntriesRange{
      gnil::config::kClipboardHistoryMinEntries,
      gnil::config::kClipboardHistoryMaxEntries,
      gnil::config::kClipboardHistoryStepEntries,
  };
