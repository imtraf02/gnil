...
int main() {
  ...
  assert(envValue(events[0], "GNIL_BATTERY_STATE") == "charging");
  assert(envValue(events[0], "GNIL_BATTERY_PERCENT") == "51");
  ...
  assert(envValue(events[1], "GNIL_BATTERY_STATE") == "fully_charged");
  assert(envValue(events[1], "GNIL_BATTERY_PERCENT") == "100");
