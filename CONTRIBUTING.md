...
`fonts/material-symbols-rounded.ttf`, and `translations/en.json`.
...
src/
  ...
  theme/            Palette generation and theme service
...
assets/
  fonts/            Bundled Material Symbols Rounded font and metadata
